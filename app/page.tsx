...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      {/* Header - Only on home page with fade-in effect */}
      <header 
        className={`fixed top-0 left-0 right-0 z-50 border-b border-gray-800/50 bg-black/80 backdrop-blur-sm transition-all duration-1000 ${
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900/50 border border-orange-500/30 rounded-full text-orange-400 text-sm font-medium backdrop-blur-sm">
          ...
          <div className="flex flex-col gap-6 max-w-2xl mx-auto">
            ...
            <div className="relative group">
              <button
                ...
                disabled={loading}
                className="relative w-full px-8 py-4 bg-gray-900/50 border border-orange-500/30 backdrop-blur-sm text-white rounded-xl font-medium text-lg transition-all duration-300 transform hover:scale-[1.02] hover:border-orange-500/50 hover:bg-gray-900/70 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none overflow-hidden group"
              >
