...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      {/* Footer */}
      <footer className="relative py-12 px-4 border-t border-gray-900/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Self-sovereign identity powered by Bitcoin. Your keys, your identity, your sovereignty.
              </p>
              <div className="flex gap-4">
                <a href="https://github.com/b-open-io/bitcoin-auth" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://github.com/b-open-io/bitcoin-auth" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Documentation</a></li>
                <li><a href="https://github.com/b-open-io/bitcoin-auth/issues" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Support</a></li>
                <li><a href="https://bitcoin.org" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Learn Bitcoin</a></li>
              </ul>
            </div>
          </div>
          
          <div className="pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
            <p>© 2024 Bitcoin Auth. Built with ❤️ for the decentralized web.</p>
          </div>
        </div>
      </footer>
    </div>
